...
pub trait ExtThis {
    fn on_ft1_balance_of(&self, account_id: AccountId, token_id: TokenId, #[callback] ft1_in_balance: U128);
    fn on_ft2_balance_of(&self, account_id: AccountId, token_id: TokenId, ft1_in_balance: U128, #[callback] ft2_in_balance: U128);
    fn on_fts_burn(&mut self, token_id: TokenId);
}

#[derive(Serialize, Deserialize)]
pub struct FlanearStats {
    pub(crate) level: u64,
    pub(crate) stamina: u64,
...
impl Contract {
    ...
    pub fn update_stats(&mut self, token_id: TokenId, account_id: ValidAccountId) -> Promise {
        ...
        ext_ft_transfer::ft_balance_of(
            ...
            0,
            5_000_000_000_000
        ).then(ext_ft_self::on_ft1_balance_of(
            account_id.into(),
            token_id,
    ...
    pub fn on_ft1_balance_of(&self, account_id: AccountId, token_id: TokenId, #[callback] ft1_in_balance: U128) -> Promise {
        ext_ft_transfer::ft_balance_of(
            ...
            0,
            5_000_000_000_000
        ).then(ext_ft_self::on_ft2_balance_of(
            account_id,
            token_id,
            ft1_in_balance,
            &env::current_account_id(),
    ...
    pub fn on_ft2_balance_of(&self, account_id: AccountId, token_id: TokenId, ft1_in_balance: U128, #[callback] ft2_in_balance: U128) -> Promise {
        ...
        ext_ft_transfer::burn(
            ...
            0,
            5_000_000_000_000
        ).then(ext_ft_transfer::burn(
            account_id.clone(),
            ft2_to_burn.into(),
            &FT2_CONTRACT_ID,
            0,
            5_000_000_000_000
        )).then(ext_ft_self::on_fts_burn(
            token_id,
            &env::current_account_id(),
            0,
            20_000_000_000_000
